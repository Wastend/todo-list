    ...
    return (
        <div className='task__list-wrap'>
            <div className="task__list-topbar">
                ...
                <button className='btn1'>Выполнено</button>
                <button className='btn2'>Не выполнено</button>
            </div>
